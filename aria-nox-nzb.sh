...
aria2c --allow-overwrite=true --auto-file-renaming=true --bt-enable-lpd=true --bt-detach-seed-only=true \
       ...
       --rpc-max-request-size=1024M --max-connection-per-server=16 --max-concurrent-downloads=1000 --split=16 \
       --seed-ratio=0 --check-integrity=true --continue=true --daemon=true --disk-cache=128M --force-save=true \
       ...
       --summary-interval=0 --max-upload-limit=0
